...
const (
	...
	BUSINESS_ACTIVE_BUDGET_CHANGED ActivityType = "BUSINESS_ACTIVE_BUDGET_CHANGED" // spec 0006: cambió el presupuesto activo (= cambió el valor del negocio; unifica #7+#15)
	...
	BUSINESS_DELETED               ActivityType = "BUSINESS_DELETED" // spec 0006: baja de negocio
